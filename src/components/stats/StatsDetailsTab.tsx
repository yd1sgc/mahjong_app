              ...
              <tr className="border-b border-neutral-800 bg-neutral-950 text-[11px] font-black text-neutral-400">
                ...
                {activeDetailTab === 'basic' && (
                  <>
                    ...
                    <th className="py-2.5 px-2 text-center">和了率</th>
                    <th className="py-2.5 px-2 text-center">ツモ率</th>
                    <th className="py-2.5 px-2 text-center">放銃率</th>
                ...
                {activeDetailTab === 'datan' && (
                  <>
                    <th className="py-2.5 px-2.5 text-right">平均和了</th>
                ...
                {activeDetailTab === 'syubi' && (
                  <>
                    ...
                    <th className="py-2.5 px-2.5 text-right">平均放銃</th>
                  </>
                )}
                {activeDetailTab === 'riichi' && (
                  <>
                    <th className="py-2.5 px-2 text-center">リーチ率</th>
                    <th className="py-2.5 px-2 text-center">立直和了率</th>
                    <th className="py-2.5 px-2 text-center">立直放銃率</th>
                  </>
                )}
                {activeDetailTab === 'furo' && (
                  <>
                    <th className="py-2.5 px-2 text-center">副露率</th>
                ...
                <tr key={r.name} className="hover:bg-neutral-850/60 transition-colors">
                  ...
                  {activeDetailTab === 'basic' && (
                    <>
                      ...
                      <td className="py-2.5 px-2 text-center font-bold text-neutral-300">{r.agariRate.toFixed(1)}%</td>
                      <td className="py-2.5 px-2 text-center font-bold text-neutral-300">{r.tsumoRate.toFixed(1)}%</td>
                      <td className="py-2.5 px-2 text-center font-bold text-neutral-300">{r.houjuRate.toFixed(1)}%</td>
                      <td className="py-2.5 px-2 text-center font-bold font-mono text-neutral-300">
                        {`${r.agariHoujuDiff.toFixed(1)}%`}
                      </td>
                      <td className="py-2.5 px-2 text-center font-bold text-neutral-300">{r.tenpaiRate.toFixed(1)}%</td>
                      <td className="py-2.5 px-2.5 text-right font-mono font-bold text-neutral-300">
                        {r.notenBappu}
                      </td>
                      <td className="py-2.5 px-2.5 text-right font-mono font-bold text-neutral-300">
                        {r.kyotakuPoint}
                  ...
                  {activeDetailTab === 'datan' && (
                    <>
                      <td className="py-2.5 px-2.5 text-right font-bold font-mono text-neutral-300">{r.avgAgari.toLocaleString()}</td>
                  ...
                  {activeDetailTab === 'syubi' && (
                    <>
                      ...
                      <td className="py-2.5 px-2.5 text-right font-bold font-mono text-neutral-300">{r.avgHouju.toLocaleString()}</td>
                    </>
                  )}
                  {activeDetailTab === 'riichi' && (
                    <>
                      <td className="py-2.5 px-2 text-center font-bold text-neutral-300">{r.riichiRate.toFixed(1)}%</td>
                      <td className="py-2.5 px-2 text-center font-bold text-neutral-300">{r.riichiAgariRate.toFixed(1)}%</td>
                      <td className="py-2.5 px-2 text-center font-bold text-neutral-300">{r.riichiHoujuRate2.toFixed(1)}%</td>
                    </>
                  )}
                  {activeDetailTab === 'furo' && (
                    <>
                      <td className="py-2.5 px-2 text-center font-bold text-neutral-300">{r.furoRate.toFixed(1)}%</td>
