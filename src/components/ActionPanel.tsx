...
export const ActionPanel: React.FC<ActionPanelProps> = ({
  ...
  return (
    <div className="w-full bg-neutral-900 border border-neutral-800 rounded-xl p-2.5 sm:p-3 flex flex-col gap-2 sm:gap-2.5 shadow-md shrink-0">
      {/* 権限状態インジケータ */}
      ...
      {isRecorder ? (
        <div className="flex flex-col gap-2">
          ...
          <div className="grid grid-cols-2 gap-2">
            <button
              ...
              className="h-11 sm:h-13 rounded-xl bg-rose-600 hover:bg-rose-500 active:scale-[0.98] text-white font-black text-lg sm:text-xl shadow-md transition-all flex items-center justify-center border border-rose-500/50 touch-manipulation"
            >
              和了
            </button>
            ...
            <button
              ...
              className="h-11 sm:h-13 rounded-xl bg-neutral-800 hover:bg-neutral-750 active:scale-[0.98] text-neutral-100 font-black text-base sm:text-lg shadow-sm transition-all flex items-center justify-center border border-neutral-700 touch-manipulation"
            >
              流局
            </button>
          </div>
          ...
          <div className="grid grid-cols-2 gap-2 pt-1 border-t border-neutral-800/60">
            <button
              ...
              className="h-9 sm:h-10 rounded-lg bg-neutral-800/80 hover:bg-neutral-700 text-neutral-300 hover:text-white font-semibold text-xs transition-colors border border-neutral-700/50 touch-manipulation flex items-center justify-center"
            >
              その他
            </button>
            ...
            <button
              ...
              disabled={!canUndo}
              onClick={onUndoClick}
              className={`h-9 sm:h-10 rounded-lg font-semibold text-xs transition-colors border touch-manipulation flex items-center justify-center ${
                canUndo
                  ? hasIntraRoundAction
        ...
        <div className="p-2.5 sm:p-3 rounded-xl bg-neutral-950/50 border border-neutral-800/80 text-center flex flex-col gap-1">
