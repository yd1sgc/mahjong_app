...
export const KO_RON_PRESETS: ScorePresetItem[] = [
...
export const OYA_RON_PRESETS: ScorePresetItem[] = [
...
export const KO_TSUMO_PRESETS: ScorePresetItem[] = [
...
export const OYA_TSUMO_PRESETS: ScorePresetItem[] = [
